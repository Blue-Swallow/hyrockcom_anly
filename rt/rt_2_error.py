...
def main(anl_df, ex_df, input_param, func_cstr, func_gamma):
    ...
    anl_df_dPc = rt_2.Main(ex_df_Pc, func_cstr, func_gamma, input_param).execute_RT()
    ...
    anl_df_dmox = rt_2.Main(ex_df_mox, func_cstr, func_gamma, input_param).execute_RT()
    ...
    anl_df_Mf = rt_2.Main(ex_df, func_cstr, func_gamma, input_param_Mf).execute_RT()
    ...
    anl_df_Dt = rt_2.Main(ex_df, func_cstr, func_gamma, input_param_Dt).execute_RT()
    ...
    anl_df["deta"] = np.sqrt(np.power(deta_dPc*dPc, 2) + np.power(deta_dmox*dmox, 2) + np.power(deta_dMf*dMf, 2) + np.power(deta_dDt*dDt, 2))
    return anl_df